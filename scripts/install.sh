...
#
#  Or clone first:
#    git clone https://github.com/Arch1eSUN/WEB4.0.git && cd WEB4.0 && bash scripts/install.sh
#
#  What this does:
...
echo "  Update:  cd ${INSTALL_DIR} && git pull && pnpm build"
echo ""
echo -e "  Docs: ${CYAN}https://web4.ai${NC}"
echo ""
